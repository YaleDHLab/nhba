    ...
    return (
      <div className='form edit-glossary'>
        <div className='form-content'>
          <h1>Glossary</h1>
          <div className='instructions'>{'Add definitions....style guide and directions here.'}</div>
          ...
          <div className='yellow-button'
            onClick={this.saveGlossary}>Save</div>
          <div className='gray-button add-new-button'
            onClick={this.addNewItem}>Add New</div>
        </div>
      </div>
    )
  }
